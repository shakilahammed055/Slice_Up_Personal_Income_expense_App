              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    reverse: true, // This will reverse the scroll, making latest messages at the top (bottom in normal view)
                    child: Container(
                        ...
                        children: [
                          Obx(
                            () => ListView.builder(
                              ...
                              reverse: true, // Reverse the list to show latest at top
                              itemCount: controller.messages.length,
                              itemBuilder: (context, index) {
                                final message = controller.messages[controller.messages.length - 1 - index]; // Reverse index
