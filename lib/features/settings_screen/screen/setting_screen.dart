...
class SettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _onRefresh() async {
      try {
        await controller.fetchProfileSettings();
        await controller.fetchCategories();
      } catch (_) {
        // Swallow errors so pull-to-refresh completes gracefully
      }
    }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildSettingItem(
                            ...
                            onTap: () =>
                                showNameBottomSheet(context, controller),
                            screenWidth: screenWidth,
                            context: context,
                          ),
                          buildSettingItem(
                            ...
                            onTap: () => showResetPasswordBottomSheet(
                              context,
                              controller,
                            ),
                            screenWidth: screenWidth,
                          ...
                          buildSettingItem(
                            ...
                            trailing: Obx(
                              () => Text(
                                "${controller.friendCount.value} ${'Friends'.tr}",
                                textAlign: TextAlign.right,
                                style: getTextStyle2(
                                  color: Color(0xFF828282),
                                  fontSize: screenWidth * 0.036,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildSettingItem(
                            ...
                            trailing: Obx(
                              () => Text(
                                // Truncate assistantType to 23 chars and append '..' if needed.
                                (() {
                                  final raw = controller.assistantType.value;
                                  final display = raw.isNotEmpty
                                      ? raw.tr
                                      : 'Supporter'.tr;
                                  if (display.length > 23) {
                                    return '${display.substring(0, 23)}..';
                                  }
                                  return display;
                                })(),
                                textAlign: TextAlign.right,
                          ...
                          buildSettingItem(
                            ...
                            onTap: () =>
                                showCurrencyDialog(context, controller),
                            screenWidth: screenWidth,
                            context: context,
                          ),
                          buildSettingItem(
                            ...
                            onTap: () =>
                                showLanguageDialog(context, controller),
                            screenWidth: screenWidth,
                            context: context,
                          ),
                          buildSettingItem(
