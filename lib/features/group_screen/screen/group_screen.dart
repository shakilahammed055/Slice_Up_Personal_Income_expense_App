    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: GestureDetector(
          onTap: () {
            // Set the BottomNavbarController to the Group tab (index 1)
            final bnController = Get.put(BottomNavbarController());
            bnController.changeTab(0);
            // Then navigate to the BottomNavbar view
      ...
      body: RefreshIndicator(
        onRefresh: tripController.fetchTrips,
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: TripBox(
                            trip: trip,
                            controllerTag: trip.id ?? 'groupTripSpent',
                          ),
                        );
                      },
                    ),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    if (tripController.trips.length >= 2) {
                      ...
                      // Clear the controller state BEFORE showing the bottom sheet (runs only once)
