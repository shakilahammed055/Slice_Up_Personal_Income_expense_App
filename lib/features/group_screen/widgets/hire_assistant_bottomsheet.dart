...
class HireAssistantBottomsheet extends StatelessWidget {
        ...
        children: [
          ...
          Opacity(
            ...
            child: _buildPlanItem(
              ...
              emoji: '🤖',
              title: 'AI Assistant Chatbot'.tr,
              isSelected: controller.isPremiumPlan && controller.selectedPlan.value == 'ai_assistant_chatbot',
              onTap: () {
                debugPrint('Tapped AI Assistant Chatbot');
                if (controller.isPremiumPlan) {
                  controller.selectPlan('ai_assistant_chatbot');
                } else {
                  controller.showComingSoon();
          ...
          Opacity(
            ...
            child: _buildPlanItem(
              ...
              emoji: '🧠',
              title: 'Smart Budget Suggestions'.tr,
              isSelected: controller.isPremiumPlan && controller.selectedPlan.value == 'smart_budget',
              onTap: () {
                debugPrint('Tapped Smart Budget Suggestions');
                if (controller.isPremiumPlan) {
                  controller.selectPlan('smart_budget');
                } else {
                  controller.showComingSoon();
  ...
  Widget _buildPricingCard(
    ...
    return GestureDetector(
      onTap: () {
        debugPrint('Tapped Pricing: $title');
        onTap();
      },
      child: Container(
        height: 68,
