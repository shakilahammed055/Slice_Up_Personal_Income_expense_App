...
class MinimizeTransactionEntry {
...
class MinimizeCard extends StatelessWidget {
  final List<MinimizeTransactionEntry> entries;
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildMinimizeRowContent(MinimizeTransactionEntry entry) {
      return Row(
        children: [
          // FROM
          CircleAvatar(
          ...
          const SizedBox(width: 6),
          const Icon(Icons.arrow_forward_ios_rounded, size: 12, color: AppColors.textGrey),
          const SizedBox(width: 6),
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, index) => buildMinimizeRowContent(entries[index]),
